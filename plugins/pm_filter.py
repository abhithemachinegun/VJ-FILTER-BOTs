     ...
     #   if not search:
      ...
      #      return
            ...
            buttons = [
                [
                    InlineKeyboardButton('Rᴇsᴜʟᴛ Pᴀɢᴇ',
                                         callback_data=f'setgs#text#{settings["text"]}#{str(grp_id)}'),
                    InlineKeyboardButton('Bᴜᴛᴛᴏɴ' if settings["text"] else 'Button',
                                         callback_data=f'setgs#text#{settings["text"]}#{str(grp_id)}')
                ],
                [
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Sᴏᴜʀᴄᴇ Cᴏᴅᴇ', url="https://t.me/atozmoviesflix")
        ],[
        ...
        btn = [[
            InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="help"),
            InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="telegram.me/player001robot")
        ]]
        await client.edit_message_media(
            query.message.chat.id, 
            query.message.id, 
